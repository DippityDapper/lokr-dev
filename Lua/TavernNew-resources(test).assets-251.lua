		...
		local theDialog =  dialogs.CreateDialog("intro",  
						    {
								...
								
						        {
						            ...
						            children = {
		                                    ...
		                                    children = {
												{
										    		...
										    		children = {
														...
														{
															type = DialogType.Response,
															text = || __R(68, "Talk to the sylvan elf."),
															condition = |d| cinematicMapHelper.InList(d.data.options, "sylvanElf"),
												    		who = || "mapCinematicId",
												    		children ={
												    			{
																	type = DialogType.Dialog,
																	text = || __D(69, "\"You fellows look like you need a fighter with my expertise. You are lucky; I am available,\"\n\nthe elf said, showing us his spear."),
														    		who = || "mapCinematicId",
														    		children = {
														    			{
																			type = DialogType.Response,
																			text = || __R(70, "Recruit him."),
																		...
																		{
																			type = DialogType.Response,
																			text = || __R(71, "Look for other recruits."),
																			jumpTo = "recruits"
																		}
														    		}
																}
														...
														{
															type = DialogType.Response,
															text = || __R(68, "Talk to the high enchantress."),
															condition = |d| cinematicMapHelper.InList(d.data.options, "Enchantress"),
												    		who = || "mapCinematicId",
												    		children ={
												    			{
																	type = DialogType.Dialog,
																	text = || __D(69, "\"I may not be the elf you're expecting, but I'll gladly join your quest.\"\n\nthe enchantress said with a wicked smile."),
														    		who = || "mapCinematicId",
														    		children = {
														    			{
																			type = DialogType.Response,
																			text = || __R(70, "Recruit her."),
														...
														{
															type = DialogType.Response,
															text = || __R(68, "Talk to the Necromancer."),
															condition = |d| cinematicMapHelper.InList(d.data.options, "Necromancer"),
												    		who = || "mapCinematicId",
												    		children ={
												    			{
																	type = DialogType.Dialog,
																	text = || __D(69, "\"I'd be delighted to make more corpses for my army. I shall revel in this chaos,\"\n\n the necromancer said, sending a chill down our spines."),
														    		who = || "mapCinematicId",
														    		children = {
														    			{
																			type = DialogType.Response,
																			text = || __R(70, "Recruit them."),
														...
														{
															type = DialogType.Response,
															text = || __R(68, "Talk to the Cleric."),
															condition = |d| cinematicMapHelper.InList(d.data.options, "Cleric"),
												    		who = || "mapCinematicId",
												    		children ={
												    			{
																	type = DialogType.Dialog,
																	text = || __D(69, "\"Any quest for the world is a quest for me!\"\n\n the cleric said, hefting his mace."),
														    		who = || "mapCinematicId",
														    		children = {
														    			{
																			type = DialogType.Response,
		                                ...
		                                {
		                                    type = DialogType.Response,
		                                    text = || __R(52, "Talk to the patrons."),
										    children = {
												{
													type = DialogType.Dialog,
													condition = |d| cinematicMapHelper.RandomChance(0.3) and not dialogs.HasFlag(d, "gotRumor3"),
													text = || __D(53, "After talking to one of the patrons for a while, he said:##\"I used to be an adventurer like you ...##but then I took an arrow to the knee.\""),
										    		who = || "mapCinematicId",
										    		onChoose = function(d)
												...
												
												{
													...
													text = || __D(54, "After talking to one of the patrons for a while, he said:##\"If you want to survive as an adventuring party, it's key to have a diverse set of skills.##Oh! I miss adventuring so!\""),
										    		who = || "mapCinematicId",
										    		onChoose = function(d)
												...
												},
												{
													...
													text = || __D(55, "After talking to one of the patrons for a while, he said:##\"I heard there are some adventurers like you scattered round these parts....##Maybe you can convince them to join your party.\""),
										    		who = || "mapCinematicId",
										    		onChoose = function(d)
												...
												},
												{
													...
													text = || __D(56, "After talking to one of the patrons for a while, he said:##\"Oh yes! Choosing what gear to carry on an adventure can be a daunting task, but having some tools on you can be a life saver.\""),
										    		who = || "mapCinematicId",
										    		onChoose = function(d)
												...
												
												{
													...
													text = || __D(57, "After talking to one of the patrons for a while, he said:##\"Yeah, I did one of those tarot readings once.##I ended up finding some treasure on the way home, but my buddy said he got cursed because of it.\""),
										    		who = || "mapCinematicId",
										    		onChoose = function(d)
												...
												},
												{
													...
													text = || __D(58, "After talking to one of the patrons for a while, he said:##\"A companion is never gonna give you up.##Never gonna let you down.##Never gonna run around and desert you.\""),
										    		who = || "mapCinematicId",
										    		onChoose = function(d)
												...
												},
												{
													...
													text = || __D(59, "After talking to one of the patrons for a while, he said:##\"Fortune is a cruel maiden ...##but she does favor the blessed.\""),
										    		who = || "mapCinematicId",
										    		onChoose = function(d)
												...
												},
												{
													...
													text = || __D(60, "After talking to one of the patrons for a while, he said:##\"I got 99 problems ...##but a drink ain't one.\""),
										    		who = || "mapCinematicId",
										    		onChoose = function(d)
												...
												
												{
													...
													text = || __D(61, "After talking to one of the patrons for a while, he said:##\"Last Easter, I found an egg.##I cracked it open and it was empty.##Just a joke ... I guess.\""),
										    		who = || "mapCinematicId",
										    		onChoose = function(d)
												...
												},
												{
													...
													text = || __D(62, "After talking to one of the patrons for a while, he said:##\"Your mother was a hamster, and your father smelt of elderberries!\""),
										    		who = || "mapCinematicId",
										    		onChoose = function(d)
												...
												},
												{
													...
													text = || __D(63, "After talking to one of the patrons for a while, he said:##\"Does your party have a name?##Mine was called John and the Fab 7.##Funny thing is, there was no John and we were only 4.\""),
										    		who = || "mapCinematicId",
										    		onChoose = function(d)
												...
												{
													type = DialogType.Dialog,
													text = || __D(64, "After talking to one of the patrons for a while, he said:##\"Hmm ... let me think ... ask me again later.\""),
										    		who = || "mapCinematicId",
										    		jumpTo = "return"
												}
									        }
...

						        {
						            type = DialogType.Dialog,
						            id = "return",
						            narrator = || __N(66, "The Prancing Tony"),
						            text = || __D(67, "\"It sure is nice to get a chance to lay back and rest from adventuring, am I right, fellas?\"\n\nthe bartender says with a welcoming smile."),
						    		icon = || "Asst_TavernNew",
						    		who = || "mapCinematicId",
						    		inheritFrom = "start"
						    	}
